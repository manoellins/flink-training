...
public class HourlyTipsExercise {
    ...
    public JobExecutionResult execute() throws Exception {
        ...
        DataStream<TaxiFare> timedfares = fares
        ...
        DataStream<Tuple3<Long, Long, Float>> hourlyTips =
                timedfares.keyBy((TaxiFare fare) -> fare.driverId)
                        .window(TumblingEventTimeWindows.of(Time.hours(1)))
                        .process(new AddTips());

        DataStream<Tuple3<Long, Long, Float>> hourlyTipMax =
                hourlyTips.windowAll(TumblingEventTimeWindows.of(Time.hours(1))).maxBy(2);

        hourlyTipMax.addSink(sink);
